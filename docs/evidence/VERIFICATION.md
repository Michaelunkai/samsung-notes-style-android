...
This project was packaged from the Codex Android implementation workspace on 2026-07-01 and updated through version `0.5.13` on 2026-07-02.
...
- Full local verification completed on 2026-07-02 for version `0.5.13`.
...
`docs\evidence\launch-screen.png` captures that earlier launched app home screen and should not be treated as current `0.5.13` device proof.
