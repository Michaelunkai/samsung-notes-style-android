...
- Notes home screen with list/grid modes, rich note-card metadata, search scopes, contextual empty states, folders, tags, favorites, pinned notes, trash, light/dark mode, and multi-select actions including batch duplicate.
