...
- Notes home screen with list/grid modes, rich note-card metadata including checklist progress and media summaries, expanded sorting, search scopes, contextual empty states, folders, tags, favorites, pinned notes, trash with restore-all/empty-trash actions, light/dark mode, and multi-select actions including select-all-visible, batch duplicate, pin/unpin, and favorite/unfavorite.
