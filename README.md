...
Current local build version: `0.4.0`.
...
- Attachment blocks using Android's document picker, durable app-private copies for shared imports, FileProvider-backed camera capture/import exposure, image previews, file metadata, open-with-Android viewer actions, and reference-aware cleanup of unlinked app-private imports/captures.
