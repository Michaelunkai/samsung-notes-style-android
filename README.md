...
- Notes home screen with list/grid modes, search scopes, contextual empty states, folders, tags, favorites, pinned notes, trash, light/dark mode, and multi-select actions including batch duplicate.
