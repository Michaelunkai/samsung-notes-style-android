...
- Home-screen widget provider with latest-note preview, latest-note open target, and quick text-note action.
- Static launcher shortcuts for quick text and handwriting notes.
